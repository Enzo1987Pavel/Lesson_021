...
class Request:
	...
	def __init__(self, job_request: str):
		...
		elif job_action == "Доставить":  # Из одного указанного места в другое
			self.__from = job_list[4]  # Откуда забирать
...
# Данные по складу 'store' и магазину 'shop'
store = Store(items={"Кружка": 50, "Фонарик": 10, "Отвертка": 10})
shop = Shop(items={"Часы": 2, "Альбом": 3, "Удлинитель": 2})
